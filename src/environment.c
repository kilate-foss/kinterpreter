...
bool
env_definevar (env_t *env, const char *name, void *value)
{
...
node_t *
env_getvar (env_t *env, const char *name)
{
        if (env == NULL || name == NULL)
                error_fatal ("Environment or name is null.");
...
bool
env_setvar (env_t *env, const char *name, void *value)
{
        if (env == NULL || name == NULL)
                error_fatal ("Environment or name is null.");
